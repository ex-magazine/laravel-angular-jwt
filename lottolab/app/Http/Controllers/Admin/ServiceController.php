        ...
        if ($request->ajax()) {
            ...
            return datatables($items)
                ...
                ->addColumn('actions', function ($item) {
                    ...
                    $html .= edit_html('admin.ammelias.serviceEdit', $item->id);
                    $html .= delete_html('admin.ammelias.serviceDelete', $item->id);
                    $html .= '</ul>';
                    return $html;
                })
    ...
    public function serviceSave(ServiceRequest $request) 
    {
        if ($request->isMethod('post')) {
            ...
            if ($response['success'] == true) {
                return redirect()->route('admin.ammelias.serviceList')->with('success', $response['message']);
            }
