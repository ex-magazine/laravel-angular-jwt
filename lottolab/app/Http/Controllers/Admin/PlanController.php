        ...
        if ($request->ajax()) {
            ...
            return datatables($items)
                ...
                ->addColumn('actions', function ($item) {
                    ...
                    $html .= edit_html('admin.ammelias.planEdit', $item->id);
                    $html .= delete_html('admin.ammelias.planDelete', $item->id);
                    $html .= '</ul>';
                    return $html;
                })
    ...
    public function planSave(PlanRequest $request)
    {
        if ($request->isMethod('post')) {
            ...
            if ($response['success'] == true) {
                return redirect()->route('admin.ammelias.planList')->with('success', $response['message']);
            }
