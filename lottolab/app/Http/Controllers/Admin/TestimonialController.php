        ...
        if ($request->ajax()) {
            ...
            return datatables($items)
                ...
                ->addColumn('actions', function ($item) {
                    ...
                    $html .= edit_html('admin.ammelias.testimonialEdit', $item->id);
                    $html .= delete_html('admin.ammelias.testimonialDelete', $item->id);
                    $html .= '</ul>';
                    return $html;
                })
    ...
    public function testimonialSave(TestimonialRequest $request)
    {
        if ($request->isMethod('post')) {
            ...
            if ($response['success'] == true) {
                return redirect()->route('admin.ammelias.testimonialList')->with('success', $response['message']);
            }
