        ...
        if ($request->ajax()) {
            ...
            return datatables($items)
                ...
                ->addColumn('actions', function ($item) {
                    ...
                    $html .= edit_html('admin.ammelias.menuEdit', $item->id);
                    $html .= delete_html('admin.ammelias.menuDelete', $item->id);
                    $html .= '</ul>';
                    return $html;
                })
                ->rawColumns(['actions'])
    ...
    public function menuSave(MenuRequest $request)
    {
        if ($request->isMethod('post')) {
            ...
            if ($response['success'] == true) {
                return redirect()->route('admin.ammelias.menuList')->with('success', $response['message']);
            }
