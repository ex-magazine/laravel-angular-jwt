                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex align-items-center">
                            <a href="{{route('admin.ammelias.galleryCategoryList')}}" class="btn btn-primary list-button px-3 mr-2">{{__('Image Category')}}</a>
                            <a href="{{route('admin.ammelias.galleryCreate')}}" class="btn btn-primary list-add-button px-3">{{__('Add New')}}</a>
...
@section('script')
    <script>
        $('#table').DataTable({
            ...
            pageLength: 25,
            responsive: true,
            ajax: '{{route('admin.ammelias.galleryList')}}',
            order: [5, 'desc'],
            autoWidth:false,
            columns: [
                {"data": "image"},
