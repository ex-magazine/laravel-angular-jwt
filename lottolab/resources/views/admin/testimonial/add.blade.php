        ...
        <div class="card add-category">
            <div class="card-body">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            {{ Form::open(['route' => 'admin.ammelias.testimonialSave', 'files' => 'true']) }}
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                                        <label>{{__('Client Name')}}<span class="text-danger">*</span></label>
                                        <input type="text" name="name" @if(isset($item)) value="{{$item->name}}" @else value="{{old('name')}}" @endif class="form-control" placeholder="Client Name">
                                        <span class="text-danger"><strong>{{ $errors->first('name') }}</strong></span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                                        <label>{{__('Client Profession')}}<span class="text-danger">*</span></label>
                                        <input type="text" name="profession" @if(isset($item)) value="{{$item->profession}}" @else value="{{old('profession')}}" @endif class="form-control" placeholder="Client profession">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="messages" id="" rows="6" class="form-control">@if(isset($item)){{$item->messages}}@else{{old('messages')}}@endif</textarea>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
