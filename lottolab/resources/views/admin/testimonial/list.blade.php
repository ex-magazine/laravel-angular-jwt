                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex align-items-center">
                            <a href="{{route('admin.ammelias.testimonialCreate')}}" class="btn list-add-button px-3">{{__('Add New')}}</a>
...
@section('script')
    <script>
        $('#table').DataTable({
            ...
            pageLength: 25,
            responsive: true,
            ajax: '{{route('admin.ammelias.testimonialList')}}',
            order: [4, 'desc'],
            autoWidth:false,
            columns: [
                {"data": "image"},
