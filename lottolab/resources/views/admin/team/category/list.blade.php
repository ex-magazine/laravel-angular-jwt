                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex align-items-center">
                            <a href="{{route('admin.ammelias.teamList')}}" class="btn btn-primary list-button px-3 mr-2">{{__('Teams')}}</a>
                            <a href="{{route('admin.ammelias.teamCategoryCreate')}}" class="btn list-add-button px-3">{{__('Add New')}}</a>
...
@section('script')
    <script>
        ...
        $('#table').DataTable({
            ...
            pageLength: 25,
            responsive: true,
            ajax: '{{route("admin.ammelias.teamCategoryList")}}',
            order: [3, 'desc'],
            autoWidth:false,
            columns: [
                {"data": "image"},
