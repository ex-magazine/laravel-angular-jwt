        ...
        <div class="card add-category">
            <div class="card-body">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            {{ Form::open(['route' => 'admin.ammelias.teamCategorySave', 'files' => 'true']) }}
                            <div class="row">
                                <div class="col-md-6">
...
<a href="{{ route('admin.ammelias.teamList') }}" class="icon-btn" ><i class="fa fa-fw fa-reply"></i>@lang('Back to Teams')</a> 
@endpush