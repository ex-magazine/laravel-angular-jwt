                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex align-items-center">
                            <a href="{{route('admin.ammelias.teamCategoryList')}}" class="btn list-button px-3 mr-2">{{__('Team Category')}}</a>
                            <a href="{{route('admin.ammelias.teamCreate')}}" class="btn list-add-button px-3">{{__('Add New')}}</a>
...
@section('script')
    <script>
        $('#table').DataTable({
            ...
            pageLength: 25,
            responsive: true,
            ajax: '{{route('admin.ammelias.teamList')}}',
            order: [5, 'desc'],
            autoWidth:false,
            columns: [
                {"data": "image"},
