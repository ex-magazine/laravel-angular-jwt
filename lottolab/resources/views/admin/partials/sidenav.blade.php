            ...
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.lottery*',3)}}">
                        <i class="menu-icon la la-ticket-alt"></i>
                        <span class="menu-title">@lang('Manage Lottery')</span>
                    </a>
                        ...
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.lottery.index')}} ">
                                <a href="{{route('admin.lottery.index')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Lotteries')</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.lottery.phase.index')}} ">
                                <a href="{{route('admin.lottery.phase.index')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Phase')</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.lottery.draw.manual')}} ">
                                <a href="{{route('admin.lottery.draw.manual')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Manual Draw')</span>
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.report*',2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive(['admin.report.winners','admin.report.winners.search'])}}">
                                <a href="{{route('admin.report.winners')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Winners')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive(['admin.report.lotTick','admin.report.lotTick.search'])}}">
                                <a href="{{route('admin.report.lotTick')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Sold Ticket')</span>
                                </a>
                            </li>
