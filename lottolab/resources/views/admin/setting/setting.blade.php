                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-lg-12 tabcontent mt-5" id="London">
                            {{ Form::open(['route' => 'admin.ammelias.saveSettings', 'files' => 'true']) }}
                            <div class="row">
                                <div class="col-lg-6">
                        ...
                        <div class="col-lg-12 tabcontent mt-5" id="Paris">
                            {{ Form::open(['route' => 'admin.ammelias.adminImageUploadSave', 'files' => 'true']) }}
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="form-group">
...
@section('script')
    <script src="{{asset('assets/admin/ammelias/colorPicker/jquery.wheelcolorpicker.js')}}"></script>
    <script src="{{asset('assets/admin/ammelias/colorPicker/jquery.wheelcolorpicker.min.js')}}"></script>
