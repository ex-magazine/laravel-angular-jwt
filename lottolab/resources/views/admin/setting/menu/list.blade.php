                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex align-items-center">
                            <a href="{{route('admin.ammelias.menuCreate')}}" class="btn list-add-button px-3">{{__('Add New')}}</a>
...
@section('script')
    <script>
        $('#table').DataTable({
            ...
            pageLength: 25,
            responsive: true,
            ajax: '{{route('admin.ammelias.menuList')}}',
            order: [4, 'asc'],
            autoWidth:false,
            columns: [
                {"data": "title"},
    ...
    <script>
        ...
        $( "#sortable" ).sortable({
            ...
            update: function( ) {
                ...
                $.get( "{{route('admin.ammelias.customMenuOrder')}}?vals="+l_ar, function( data ) {
                    $( ".result" ).html( data );
